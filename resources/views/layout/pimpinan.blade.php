...
<head>
    ...
    <!-- =======================================================
  * Template Name: Nicepimpinan
  * Updated: Mar 09 2023 with Bootstrap v5.2.3
  * Template URL: https://bootstrapmade.com/nice-pimpinan-bootstrap-pimpinan-html-template/
...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center" style='background:#0b381a;'>
        <div class="d-flex align-items-center justify-content-between">
            <a href="/pimpinan/dashboard" class="logo d-flex align-items-center">
            ...
            <ul class="d-flex align-items-center">
                ...
                <li class="nav-item dropdown pe-3">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                        <li>
                            <a class="dropdown-item d-flex align-items-center" href="/pimpinan/profile">
    ...
    <aside id="sidebar" class="sidebar">
        <ul class="sidebar-nav" id="sidebar-nav">
            <li class="nav-item">
                <a class="nav-link collapsed" href="/pimpinan/dashboard">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="/pimpinan/paket_umrah">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="/pimpinan/jamaah">
                    <i class="bi bi-person"></i>
                    <span>Jamaah</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="/pimpinan/keberangkatan">
