                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="d-flex justify-content-center py-4">
                                <a href="index.html" class="logo d-flex align-items-center w-auto">
                                    ...
                                    <span class="d-none d-lg-block text-black">Baiturrahim Travel</span>
                                </a>
                            </div><!-- End Logo -->
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="pt-4 pb-2">
                                        <h5 class="card-title text-center pb-0 fs-4 text-black"><i
                                                class="ri-user-3-fill text-black"></i> Forgot Password</h5>
                                    </div>
                                    ...
                                    <form class="row g-3 needs-validation"
                                        action="auth/lupa_password/updatelupapassword" method='post' novalidate>
